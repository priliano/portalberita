                        ...
                        <div class="about-right mb-90">
                            ...
                            <div class="about-prea">
                                ...
                                <p class="about-pera1 mb-25">
                                    ...
                                    The reflector telescope has a concave lens which means it telescope sits on. The
                            ...
                            <div class="col-lg-8">
                                <form class="form-contact contact_form mb-80" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input class="form-control error" name="number" id="number" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your number'" placeholder="Enter your number">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input class="form-control error" name="file" id="file" type="file" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Select file'" placeholder="Select file">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
