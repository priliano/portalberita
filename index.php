                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li><img src="assets/img/icon/header_icon1.png" alt="">28ºC, Cloudy</li>
                                        <li><img src="assets/img/icon/header_icon1.png" alt="">Friday, 20th January, 2024</li>
                                    </ul>
                                </div>
                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                ...
                                <div class="trend-top-cap">
                                    ...
                                    <h2><a href="details.html">Indonesia won convincingly 1-0 <br>against Vietnam in the 2024 Asian Cup</a></h2>
                                </div>
                            </div>
                        </div>
                        <!-- Trending Bottom -->
                            ...
                            <div class="row">
                                ...
                                <div class="single-bottom mb-35">
                                    ...
                                    <div class="trend-bottom-cap">
                                        ...
                                        <h4><a href="details.html">Cases of Childhood Diabetes in the City of Surabaya Have Increased</a></h4>
                                    </div>
                                </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><h4><a href="details.html">Fajar/Rian Eliminated, Indonesia Without Representatives in the Semifinals of the India Open</a></h4></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        ...
                                        <div class="trend-bottom-cap">
                                            ...
                                            <h4><a href="details.html">Prabowo-Gibran's Electability Reaches 50 Percent in 2 Surveys, What's the Reason?</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
